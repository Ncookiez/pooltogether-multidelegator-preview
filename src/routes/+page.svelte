<script lang="ts">
  ...
  import { calculateDprMultiplier } from '$lib/dpr';
	...
	$: apr = maxPrizes && prizeTiers && protocolTVL.total !== 0 ? fetchAPR(prizeTiers, maxPrizes, protocolTVL.total, avgDelegation) : 0;
...
<section>
	...
	<!-- Settings Component -->
	<Settings bind:maxPrizes bind:prizeTiers bind:chain bind:dpr />
